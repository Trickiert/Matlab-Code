...
classifier = fitcnb(input_training_set,output_training_set); % train The Bayes classifier using the training samples
disp(classifier) % get a brief description of the classifier.
