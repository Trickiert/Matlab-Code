...
net = newff(input_training_set,output_training_set,[10 5]); % create a network for non-linear regression, 10 neurons in first hidden layer 
% and 5 in the second.
net.layers{1}.transferFcn='logsig';  % transfer function for the neurons in first hidden layer is log sigmoid.
net.layers{2}.transferFcn='logsig';  % transfer function for the neurons in second hidden layer is log sigmoid.
