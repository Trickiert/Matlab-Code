...
svmStruct = svmtrain(input_training_set,output_training_set,'Kernel_Function','linear','showplot',true); %#ok<SVMTRAIN> %Built in SVM function
xlabel('Petal length'); % add label for horizontal axis
ylabel('Petal width');   % add label for the vertical axis
